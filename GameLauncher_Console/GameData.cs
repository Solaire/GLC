...
namespace GameLauncher_Console
{
	...
	static public class CGameData
	{
		...
		public class Game
		{
			...
			protected Game(string strTitle, string strLaunchCommand, bool bIsFavourite, GamePlatform enumPlatform)
			{
				m_strTitle		= strTitle;
		...
		/// </summary>
		private class GameInstance : Game
		{
			/// <summary>
			/// Constructor.
			...
			/// <param name="bIsFavourite">Flag indicating if the game is in the favourite tab</param>
			/// <param name="enumPlatform">Game's platform enumerator</param>
			public GameInstance(string strTitle, string strLaunchCommand, bool bIsFavourite, GamePlatform enumPlatform) 
		...
		private static Game CreateGameInstance(string strTitle, string strLaunchCommand, bool bIsFavourite, GamePlatform enumPlatform)
		{
			return new GameInstance(strTitle, strLaunchCommand, bIsFavourite, enumPlatform);
		}

		private static Dictionary<GamePlatform, List<Game>> m_games = new Dictionary<GamePlatform, List<Game>>();
		...
		public static List<Game> GetGames(GamePlatform enumPlatform)
		{
		...
		public static void AddGame(string strTitle, string strLaunchCommand, bool bIsFavourite, string strPlatform)
		{
			...
			{
				m_games[enumPlatform] = new List<Game>();
			}
